...
with st.expander("Description"):
    st.info("""A Simple ML Model to predict IPL Score between two teams in an ongoing match. To make sure the model results accurate score and some reliability the minimum no. of current overs considered is greater than 5 overs.
...
if bowling_team==batting_team:
    st.error('bowling team and batting team should be different')
#bowling team
...
with col1:
    ...
    if overs-math.floor(overs)>0.50:
